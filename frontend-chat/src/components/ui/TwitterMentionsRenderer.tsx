...
export const TwitterMentionsRenderer: React.FC<TwitterMentionsProps> = memo(({ content }) => {
  ...
  const [fullscreenTweetId, setFullscreenTweetId] = useState<string | null>(null);
  ...
  const handleTweetDoubleClick = (id: string, e: React.MouseEvent | React.TouchEvent) => {
